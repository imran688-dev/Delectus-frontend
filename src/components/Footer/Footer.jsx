      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-2 sm:px-6 lg:px-8">
          ...
          >
            ...
            <a
              className="inline-flex items-center gap-2 rounded-full border border-white bg-white px-8 py-3 text-indigo-500 hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
              href="#"
            >
          ...
          <div className="mt-1">
            ...
            <div className="mt-5 sm:flex sm:items-center sm:justify-between">
              <div className="flex justify-center text-indigo-700 sm:justify-start">
                <a
                  id="WindUI"
                ...
                >
                  ...
                  <span className="text-2xl uppercase font-semibold">Delectus</span>
                </a>
              </div>

              <p className="text-center pb-0 text-sm text-gray-500 sm:mt-0 sm:text-right">
