        ...
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            <ul
              ...
              className={`absolute left-0 top-0 z-[-1] h-[28.5rem] mt-2 w-full justify-center overflow-hidden  overflow-y-auto overscroll-contain bg-white/90 px-8 pb-12 pt-24 font-medium transition-[opacity,visibility] duration-300 lg:visible lg:relative lg:top-0  lg:z-0 lg:flex lg:h-full lg:w-auto lg:items-stretch lg:overflow-visible lg:bg-white/0 lg:px-0 lg:py-0  lg:pt-0 lg:opacity-100 ${isToggleOpen
              ...
              <li role="none" className="flex items-stretch">
                <NavLink to={"/"}>
                  <a
                    role="menuitem"
                    aria-haspopup="false"
                    className="flex items-center gap-2 py-4 transition-colors duration-300 text-indigo-700 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none focus-visible:outline-none lg:px-8"
                    href="javascript:void(0)"
                  >
                    <span>Home</span>
                  </a>
              ...
              <li role="none" className="flex items-stretch">
                <NavLink to={"/about"}>
                  <a
                    ...
                    aria-current="page"
                    aria-haspopup="false"
                    className="flex items-center gap-2 py-4 transition-colors duration-300 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none focus-visible:outline-none lg:px-8"
                    href="javascript:void(0)"
                  >
                    <span>About</span>
                  </a>
